# -*- coding: utf-8 -*-
"""
Created on Thu Aug 13 16:04:09 2020
...
plastic = pd.read_csv("D:\STUDY\Excelr Assignment\Assignment 17 - Forecasting\PlasticSales.csv")
...
#final model is 
plasticnew1= pd.read_csv("C:\\Users\\Hello\\Desktop\\Data science\\data science\\assignments\\forcasting\\assignment data set\\plasticcsv.csv")

finalmodel =smf.ols('Sales~t+Jan+Feb+Mar+Apr+May+Jun+Jul+Aug+Sep+Oct+Nov+Dec',data=plastic1).fit()
predictfinal=pd.Series(finalmodel.predict(plasticnew1))
predictfinal

#INFERENCE
# I used different types of model to predict this values with Data Driven Approach 