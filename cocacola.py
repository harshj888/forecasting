...
cocola = pd.read_excel("D:\STUDY\Excelr Assignment\Assignment 17 - Forecasting\CocaCola_Sales_Rawdata.xlsx")

# Boxplot for ever
sns.boxplot("Sales",data=cocola)

#histogram 
sns.distplot(cocola['Sales'])
...
decompose_ts_add = seasonal_decompose(cocola.Sales,model="additive", freq=1)
decompose_ts_add.plot()
decompose_ts_mul = seasonal_decompose(cocola.Sales,model="multiplicative", freq=1)
...
#INFERENCE
# I used different types of model to predict this values with Data Driven Approach and I think Holt winter model is best for this forecasting and Sales Trends shown in the Graph which predict future values. 